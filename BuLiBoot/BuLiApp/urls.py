...
from BuLiApp.views import BestenlisteView, SpieltagView, NewsView, UserFormView, FormView, FormHorizontalView, FormInlineView, PaginationView,  ImpressumView, TestPageView
